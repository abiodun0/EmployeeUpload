...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function userValid() {
            var YourName, YourEmail, emailExp;
 
            Name = document.getElementById("YourName").value;
            EmailId = document.getElementById("YourEmail").value;
            emailExp = /^([a-zA-Z0-9_\.\-])+\@(([a-zA-Z0-9\-])+\.)+([com\co\.\in])+$/; // to validate email id
 
            if (Name == '' && EmailId == '') {
                alert("Your Name and Email Address is Required");
                return false;
            }
            if (Name == '') {
    ...
    <table width="480px" cellpadding="5" cellspacing="5" border="0">
            ...
            <td>
                <table class="ContainerWrapper" border="0" cellpadding="2" cellspacing="0" width="100%">
                    <tr class="ContainerHeader">
                        <td>
                            Customer Registration and File Upload
                        </td>
                    </tr>
                    <tr>
                                        ...
                                        <div id="dvUploader">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                 ...
                                                 <tr> 
                                                    ...
                                                    <td style="width: 50%">
                                                    <asp:TextBox ID="YourName" runat="server" Width="150px" /> <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*"
        ...
        <asp:TextBox ID="YourEmail" runat="server" Width="150px" />
            ...
            ValidationGroup="save" />
                                               ...
                                               <td> 
                                                   <asp:TextBox ID="TextBox1" runat="server" ViewStateMode="Enabled" Width="150px" ></asp:TextBox>
                                                  </td>
                                               ...
                                               <td> <asp:DropDownList ID="DropDownList1" runat="server">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>
                                                        <input id="upload" type="button" value="Upload" /></td>
        ...
        <tr>
            ...
            <tr><td align="center">
        <asp:Button ID="Button1" OnClick="Button1_Click" runat="server" Text="Register" Height="37px" Width="180px" OnClientClick="return userValid();" /></td></tr></table><asp:Label runat="server" ID="Label1" Text=" "></asp:Label>
    </form>
</body>
</html>
