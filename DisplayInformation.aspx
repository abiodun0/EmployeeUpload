<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayInformation.aspx.cs" Inherits="DisplayInformation" %>
...
<body>
    ...
    <table width="480px" cellpadding="5" cellspacing="5" border="0">
        <tr>
            <td>
                <table class="ContainerWrapper" border="0" cellpadding="2" cellspacing="0" width="100%">
                    <tr class="ContainerHeader">
                        <td>
                            Search With Your Transaction Number
                        </td>
                    </tr>
                    <tr>
            ...
            ControlToValidate="YourEmail" ValidationGroup="save" /><br /><asp:Label runat="server" ID="Label1" Text=""></asp:Label>
        <asp:TextBox ID="YourEmail" runat="server" Width="150px" />
            ...
            ValidationGroup="save" />
                                               ...
                                               <td> 
                                                   <asp:TextBox ID="TransactionNo" runat="server" ViewStateMode="Enabled" Width="150px" ></asp:TextBox><br /><asp:Label runat="server" ID="Label2" Text=""></asp:Label>
                                                  </td>
                                                   
                                                     </tr>
                                               <tr><td>&nbsp;</td></tr>
                                               <tr><td>&nbsp;</td><td>
                                                    <asp:Button ID="Button1" OnClick="Button1_Click" runat="server" Text="Search" Height="37px" Width="180px" /></td></tr>
                                              <%-- 
                                                 <tr>
        ...
        <tr>
         ...
         <%--   <table width="70%">
            <tr><td align="center">
     <asp:Button ID="Button1" runat="server" Text="Register" Height="37px" Width="180px" /></td></tr></table> --%>
    </form>
</body>
</html>